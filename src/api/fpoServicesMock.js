  ...
  return {
    ...
    data: {
      ...
      data: {
        ...
        quantityType: payload.quantityType,
        quantity: payload.quantity,
        cibRcNumber: payload.cibRcNumber,
        cibRcIssueDate: payload.cibRcIssueDate,
        expiryDate: payload.expiryDate,
        batchNo: payload.batchNo,
        remarks: payload.remarks,
  ...
  return {
    ...
    data: [
      ...
      },
      {
        ...
        fpoId: 1,
        insecticideType: 2,
        insecticideTypeName: "Chemical Pesticides",
