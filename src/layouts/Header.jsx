			...
			<nav className="fpo-nav-desktop">
			  ...
			  <a href="/gallery" className="fpo-nav-link">Gallery</a>
					...
					<div className="fpo-header-right">
						{!hideDashboard && <button className="h-[32px] w-[92px] border #f2f4c2 bg-green-600 text-white hover:bg-green-700 rounded-lg text-sm font-semibold"><a href="dashboard" className="">Dashboard</a>
						</button>}
						{!hideLogout && (
							<button
								onClick={handleLogout}
								className="h-[32px] w-[102px] border #f2f4c2 bg-green-600 text-white hover:bg-green-700 rounded-lg text-sm font-semibold"
							>
								Logout
							</button>
						)}

						{!hideProfile && <Button buttonClassName="fpo-profile-avatar hover:bg-green-800" aria-label="Profile">
							G
						</Button>}
