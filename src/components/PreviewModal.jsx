...
export default function PreviewModal({
    ...
    // Update local description if prop changes (e.g. opening with new data)
    useEffect(() => {
            ...
            <div className="relative w-full max-w-4xl rounded-lg bg-white shadow-xl mx-4 animate-fade-in-up flex flex-col max-h-[90vh]">
                ...
                <div className="overflow-y-auto p-4 md:p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full min-h-[100px] p-3 rounded-md border border-stroke-300 focus:outline-none focus:ring-1 focus:ring-primary-500 text-gray-700 text-sm md:text-base leading-relaxed resize-y"
                ...
                <div className="p-4 md:p-6 border-t border-stroke-100 flex flex-col sm:flex-row justify-end gap-3 bg-gray-50 rounded-b-lg">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-6 py-2 rounded-md bg-success text-white font-medium hover:bg-[#2e7d10] transition-colors shadow-sm flex items-center justify-center gap-2"
                    >
